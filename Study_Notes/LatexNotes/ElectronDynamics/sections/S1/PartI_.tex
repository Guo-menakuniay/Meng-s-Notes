...
\section{介质的电磁性质}
	...
	\subsection{介质的极化}
		\begin{wrapfigure}{r}{4cm}%靠文字内容的右侧
      		\centering
      		\includegraphics[width=0.28\textwidth]{/Users/menakuniay/Library/CloudStorage/OneDrive-个人/Study/LaTeX文稿/Latex笔记/ElectronDynamics/figs/介质极化示意图.jpeg}
      		\caption{介质的极化}
      		\label{fig.介质的极化}
      		\end{wrapfigure}
	...
	\subsection{介质的磁化}
		\begin{wrapfigure}{r}{4.5cm}%靠文字内容的右侧
	      \centering
	      \includegraphics[width=0.2\textwidth]{/Users/menakuniay/Library/CloudStorage/OneDrive-个人/Study/LaTeX文稿/Latex笔记/ElectronDynamics/figs/分子电流磁化.jpg}
	      \caption{分子电流磁化}
	      \end{wrapfigure}
	...
	\subsection{介质中的Maxwell方程组}
		...
		\begin{figure}[H]
						\centering  % width栏调节相对行宽的大小
						\includegraphics[width=0.9\linewidth]{/Users/menakuniay/Library/CloudStorage/OneDrive-个人/Study/LaTeX文稿/Latex笔记/ElectronDynamics/figs/介质中电场磁场对应关系.jpeg}
	...
	\subsection{电磁场边值关系}
		...
		\begin{wrapfigure}{r}{4.5cm}%靠文字内容的右侧
	      \centering
	      \includegraphics[width=0.12\textwidth]{/Users/menakuniay/Library/CloudStorage/OneDrive-个人/Study/LaTeX文稿/Latex笔记/ElectronDynamics/figs/磁化面电流示意图.jpg}
	      \caption{磁化面电流示意图}
	      \end{wrapfigure}
