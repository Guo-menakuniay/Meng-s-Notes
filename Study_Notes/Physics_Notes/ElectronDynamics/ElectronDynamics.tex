...
\pagenumbering{arabic}
	\chapter{电磁现象的普遍规律}
		\include{sections/S1/PartI_.tex}
	\chapter{静电场}
		\include{sections/S2/PartII.tex}
	\chapter{静磁场}
	
	\chapter{电磁波的传播}
		\include{sections/S4/PartIV.tex}
	\chapter{电磁波的辐射}
		\include{sections/S5/PartV.tex}
		
	% \include{sections/Appendix/Appendies}  
